                    ...
                    <div class="container mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-4">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <a href="attendance.php"> <button id="markAttendanceBtn" class="btn btn-success btn-mark-attendance">Mark Attendance</button></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Click the button below to view and mark today's attendance.</p>
                                        <a href="attendance.php"><button id="markAttendanceBtn" class="btn btn-info btn-mark-attendance">View Attendance</button></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h5 class="card-title">Request a Leave</h5>
                                        <p class="card-text">Click the button below to request a leave for today.</p>
                                        <a href="leave_req.php"> <button id="markAttendanceBtn" class="btn btn-warning btn-mark-attendance">Request a Leave</button></a>
                                    </div>
                                </div>
                            </div>
